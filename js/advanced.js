...
function render() {
  ...
  root.querySelectorAll('.advanced-download').forEach(b=>b.onclick=()=>download(`YeastFit_${b.dataset.table}.csv`,tables[b.dataset.table]||[]));renderPlots(data);
}
